...
var IndicatorImp = /** @class */ (function () {
    function IndicatorImp(indicator) {
        ...
        this.styles = styles !== null && styles !== void 0 ? styles : {};
...
var SeparatorWidget = /** @class */ (function (_super) {
    ...
    SeparatorWidget.prototype.updateImp = function (container, bounding, level) {
...
var Pane = /** @class */ (function () {
    ...
    Pane.prototype.update = function (level) {
        ...
        if (this._bounding.width !== this._seriesContainer.offsetWidth) {
            this._seriesContainer.style.width = "".concat(this._bounding.width, "px");
        }
        var seriesHeight = this._mainWidget.getBounding().height;
        if (seriesHeight !== this._seriesContainer.offsetHeight) {
            this._seriesContainer.style.height = "".concat(seriesHeight, "px");
        }
    ...
    Pane.prototype.createYAxisWidget = function (_container) { return null; };
    return Pane;
}());
